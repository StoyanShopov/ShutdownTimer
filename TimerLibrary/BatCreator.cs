namespace TimerLibrary
{
    ...
    public class BatCreator
    {
        ...
        private const string hibernate = "HibernateCommand";
        private const string restart = "RestartCommand";
        private const string shutdown = "ShutdownCommand";
        ...
        public void AbortShutdown()
        {
           ...
           // MessasgeBox.Show($"Your aborted successfully all commands!");
        }
